...
export const analyticsData = {
  ...
  newParticipants: 312,
  typeDistribution: [
    { typeName: '折扣促销', count: 50 },
    { typeName: '会员专享', count: 33 },
    { typeName: '线下活动', count: 17 },
  ],
  monthlyTrend: [
    { month: '1月', count: 98 },
    { month: '2月', count: 112 },
  ...
  ranking: [
    { rank: 1, title: '清明假期满减活动', typeName: '折扣促销', actualCount: 723 },
    { rank: 2, title: '春节特惠活动', typeName: '折扣促销', actualCount: 342 },
    { rank: 3, title: '新品上市发布会', typeName: '线下活动', actualCount: 198 },
    { rank: 4, title: '会员日专属福利', typeName: '会员专享', actualCount: 167 },
    { rank: 5, title: '老客户回馈专场', typeName: '会员专享', actualCount: 62 },
  ],
